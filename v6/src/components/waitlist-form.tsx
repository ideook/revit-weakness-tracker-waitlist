  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register("company")}
            className="bg-slate-800/50 border-slate-600 text-slate-200 placeholder-slate-400 focus:border-emerald-400 focus:ring-emerald-400/20"
          />
        </div>

        <div className="space-y-2">
          <Label htmlFor="role" className="text-slate-300 font-medium">Role</Label>
          <Input
            id="role"
            type="text"
            placeholder="Architect, Engineer, BIM Manager..."
            {...register("role")}
            className="bg-slate-800/50 border-slate-600 text-slate-200 placeholder-slate-400 focus:border-emerald-400 focus:ring-emerald-400/20"
          />
        </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="painPoint" className="text-slate-300 font-medium">What's your biggest BIM challenge? (Optional)</Label>
          <Input
            id="painPoint"
            type="text"
            placeholder="e.g., slow workflows, finding the right plugins..."
            {...register("painPoint")}
            className="bg-slate-800/50 border-slate-600 text-slate-200 placeholder-slate-400 focus:border-emerald-400 focus:ring-emerald-400/20"
          />
        </div>
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            type="checkbox"
            {...register("updates")}
            className="w-4 h-4 rounded border-slate-600 bg-slate-800/50 text-emerald-400 focus:ring-emerald-400/20 focus:ring-2"
          />
          <Label htmlFor="updates" className="text-slate-400 text-sm">
            Send me development updates and early access opportunities
          </Label>
        </div>
      </div>
